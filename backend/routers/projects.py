	...
	try:
		...
		if "Administrator" in user_roles:
			...
			if project_name not in managed_projects:
				raise HTTPException(
					status_code=status.HTTP_403_FORBIDDEN, detail="Not authorized to view this project."
				)
		elif "Client" in user_roles:
...
async def update_project(
	project_name: str,
	project_data: dict,
	current_user: Annotated[str, Depends(has_role(["Project Manager", "Administrator"]))],
):
	try:
